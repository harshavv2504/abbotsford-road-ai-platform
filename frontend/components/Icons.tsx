...
export const MicIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 19a4 4 0 0 1-4-4h2a2 2 0 0 0 4 0h2a4 4 0 0 1-4 4z"></path>
  </svg>
);
...
export const CrmIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <path d="M19 8v3h-2V8h2m4-4H1v18h22V4zm-2 16H3V6h18v14z"/>
    </svg>
);
...
export const MapPinIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    <path d="M10 2a5 5 0 00-5 5c0 3.52 5 9.5 5 9.5s5-5.98 5-9.5a5 5 0 00-5-5zm0 8a3 3 0 110-6 3 3 0 010 6z" />
  </svg>
);

export const SortIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M2.25 3A.75.75 0 013 3.75h14a.75.75 0 000-1.5H3A.75.75 0 002.25 3zm0 5.5A.75.75 0 013 9.25h10a.75.75 0 000-1.5H3a.75.75 0 00-.75.75zM2.25 14A.75.75 0 013 14.75h4a.75.75 0 000-1.5H3a.75.75 0 00-.75.75z" clipRule="evenodd" />
    </svg>
);
...
export const ChartBarIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path d="M11.5 16.5a.5.5 0 01-1 0V3.78l-1.72 1.72a.5.5 0 01-.708-.708l2.5-2.5a.5.5 0 01.708 0l2.5 2.5a.5.5 0 01-.708.708L11.5 3.78v12.72zM4.5 3.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v13a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-13zM15 8.5a.5.5 0 00-.5.5v8a.5.5 0 00.5.5h2a.5.5 0 00.5-.5v-8a.5.5 0 00-.5-.5h-2z" />
    </svg>
);